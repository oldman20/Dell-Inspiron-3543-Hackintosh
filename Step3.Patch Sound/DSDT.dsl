 ...
 *
 * Disassembly of DSDT.aml, Mon May  7 10:46:59 2018
 *
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "WN09   ", 0x01072009)
{
    ...
    External (_SB_.PCI0.GFX0.DSLP, UnknownObj)    // Warning: Unknown object
    ...
    Scope (_SB)
    {
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                OperationRegion (CPSB, SystemMemory, 0xA438FF18, 0x10)
            ...
            Name (BUF0, ResourceTemplate()
{
    ...
    {
        Store (0x03E8, \_SB.PCI0.GFX0.DSLP)
        SOST ()
        SMI (0x7A, Zero)
        P8XH (Zero, 0xC7)
        Store (ECG5 (), MIS0)
